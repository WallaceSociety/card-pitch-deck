...
export const cards: Card[] = [
  ...
  },
  {
    ...
    imageBefore: './images/site_transformation/will-rogers-before.png',
    imageBeforeObjectFit: 'contain',
    imageAfter: './images/site_transformation/will-rogers-after.png',
    ...
    buttons: [
      {
        ...
        detail: './sounds/professional_branding/trust_building.mp3',
      },
      {
        label: 'Sanctioning Body Compliance',
        action: 'sound',
        value: 'sanctioning_body_compliance_clicked',
        detail: './sounds/professional_branding/compliance.mp3',
      },
      {
        label: 'Fan Recognition',
        action: 'sound',
        value: 'fan_recognition_clicked',
        detail: './sounds/professional_branding/fan_recognition.mp3',
      },
      {
        label: 'Marketing Impact',
        action: 'sound',
        value: 'marketing_impact_clicked',
        detail: './sounds/professional_branding/marketing_impact.mp3',
      },
    ],
    ...
    items: [
      {
        ...
        audio: './sounds/attendee_communications/build_your_fan_base.mp3',
      },
      {
        label: 'Automated Event Reminders',
        audio: './sounds/attendee_communications/automated_event_reminders.mp3',
      },
      {
        label: 'Year-Round Engagement',
        audio: './sounds/attendee_communications/year-round_engagement.mp3',
      },
      {
        label: 'Advanced Email Reports',
        audio: './sounds/attendee_communications/advanced_email_reports.mp3',
      },
    ],
    cta: {
