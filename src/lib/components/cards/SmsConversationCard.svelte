<script lang="ts">
  ...
  function startTypingSound() {
    if (typingSound && currentIndex < card.messages.length && 
  ...
  <div class="flex flex-col h-full bg-gray-100">
    ...
    >
      ...
      {#if showTyping && currentIndex < card.messages.length}
        <div 
          class="flex {card.messages[currentIndex].sender === card.messages[0].sender ? 'justify-start' : 'justify-end'}"
        >
...
<audio 
  bind:this={messageSound}
  src="/src/lib/sounds/message.mp3"
  preload="auto"
></audio>

<audio 
  bind:this={typingSound}
  src="/src/lib/sounds/typing.mp3"
  preload="auto"
></audio>